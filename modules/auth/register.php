...
<div class=" shadow d-flex justify-content-center align-items-center container ">
        <div class="row " style="width:380px;">
            <div class=" col ">
                <h2 class="text-center"><p class="fs-1 --bs-success-text-emphasis login">REGISTER</p></h2>
                <form action="" method="post">
                    ...
                    <div class="text-center">
                        <button type="submit" class=" m-2 btn btn-primary btn-lg btn-block w-btn-lg btn-shadow">REGISTER</button>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col text-center" style="">
                            <a class="btn btn-outline-success w-btn-lg btn-shadow" href="?module=auth&action=login" role="button">Login</a>
                        </div>
                    </div> 
                </form>
            </div>
